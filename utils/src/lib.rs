...
pub mod config {
    ...
    pub struct Config {
        ...
        /// The configuration entries related to zookeeper
    ...
    pub struct ConfigZookeeper {
        ...
        // TODO: Make this a ZkConnectString ultimately, but ZkConnectString
        // will need a Deserialize instance first
        pub connect_string: String,
        /// The path to the zookeeper node to watch
        pub path: String
    }
    ...
    impl Default for ConfigZookeeper {
        fn default() -> Self {
            Self {
                connect_string: String::from("127.0.0.1"),
                path: String::from("/manatee")
            }
        }
    }
